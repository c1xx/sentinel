...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to bitcored "gobject list" output
    ...
    def bitcored_serialise(self):
        import bitcorelib
        return bitcorelib.SHIM_serialise_for_bitcored(self.serialise())
